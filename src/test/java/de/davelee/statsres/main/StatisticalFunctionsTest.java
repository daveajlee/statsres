...
public class StatisticalFunctionsTest {
	...
	public void testMean () {
		...
		numericalData.add(1.0); numericalData.add(2.0); numericalData.add(3.0);
	...
	public void testMin() {
		List<Double> numericalData = new ArrayList<Double>();
		numericalData.add(2.0); numericalData.add(1.0); numericalData.add(3.0);
	...
	public void testMax() {
		List<Double> numericalData = new ArrayList<Double>();
		numericalData.add(2.0); numericalData.add(1.0); numericalData.add(3.0); numericalData.add(2.5);
	...
	public void testFirstQuartile() {
		List<Double> numericalData = new ArrayList<Double>();
		numericalData.add(2.0); numericalData.add(1.0); numericalData.add(3.0); numericalData.add(2.5);
		numericalData.add(5.0); numericalData.add(6.0);
